...
1) При реализации домашнего задания использовались несколько моделей
- qwen3:8b локальная модель из примера, работает очень медленно. Плохо распознает сложные промпты - хороших результатов получить не удалось.
...
- deepseek-v3.1:671b-cloud облачная модель из Ollama. Только с ней удалось получить отличные результаты. Все примеры выше реализованы на данной модели.
